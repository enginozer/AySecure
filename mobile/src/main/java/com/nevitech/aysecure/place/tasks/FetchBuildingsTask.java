...

{
    ...
    public FetchBuildingsTask(FetchBuildingsTaskListener fetchBuildingsTaskListener,
                              Context ctx)
...

    {
...

        {
            ...
            //Uses GZIP encoding
            response = NetworkUtils.downloadHttpClientJsonPost(NevitechAPI.getFetchBuildingsUrl(), j.toString());
