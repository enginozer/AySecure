...

{
    ...
    public void add(final List<ScanResult> wifiList,
                    final String           curLocation,
                    final Float            raw_heading,
...

        {
...

            {
...

                {
                    ...
                    LogRecordMap lr = new LogRecordMap(timestamp,
                                                       lat,
                                                       lng,
                                                       raw_heading,
                                                       isWalking,
    ...
    public void save(final String endLocation,
                     final String folder_path,
                     final String filename_rss,
    ...
    private void distributeLineSamples(double lat,
                                       double lng)
     ...
     * */
    private void write_to_log(String folder_path,
                              String filename_rss,
                              String currentFloor,
