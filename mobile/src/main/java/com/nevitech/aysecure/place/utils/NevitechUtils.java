...
public class NevitechUtils

{

    public static File getFolderRootFolder(Context ctx,
    ...
    public static File getRadioMapFoler(Context ctx,
                                        String buid,
                                        String floor) throws Exception
