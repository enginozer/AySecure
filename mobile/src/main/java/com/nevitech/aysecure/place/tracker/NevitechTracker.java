...
import com.nevitech.aysecure.place.nav.AnyUserData.FakeResults;
...
import com.nevitech.aysecure.airplace.algorithms.LogRecord;
import com.nevitech.aysecure.airplace.algorithms.RadioMap;

public class NevitechTracker

{
    ...
    public NevitechTracker(SensorsMain positioning)
...

    {
...

        {
            ...
            // }
            // } else {
            String calculatedLocation = com.nevitech.aysecure.airplace.algorithms.Algorithms.ProcessingAlgorithms(latestScanList, rm, algoChoice);
