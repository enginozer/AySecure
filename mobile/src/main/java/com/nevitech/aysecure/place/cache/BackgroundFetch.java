...
import com.nevitech.aysecure.place.cache.BackgroundFetchListener.ErrorType;
...
import com.nevitech.aysecure.place.tasks.FetchFloorPlanTask;
import com.nevitech.aysecure.place.tasks.FetchFloorsByBuidTask.FetchFloorsByBuidTaskListener;

@SuppressWarnings("serial")
public class BackgroundFetch implements Serializable,Runnable

{
    ...
    BackgroundFetch(BackgroundFetchListener l,
                    BuildingModel build)
    {
...

    {
...

        {
...

            {
                ...
                currentTask  = new FetchFloorPlanTask(MyApplication.getAppContext(),
                                                      build.buid,
                                                      f.floor_number);
...

        {
...

            {
...

                {
                   ...
                   build.getLatitudeString(),
                   build.getLongitudeString(),
                   build.buid,
                   f.floor_number,
                   false);
